...
<p><img src="/markdown/ai/assets/Pasted image 20240412105248.png" alt="Pasted image 20240412105248.png"></img></p>
...
<p><img src="/markdown/ai/assets/Pasted image 20240412110720.png" alt="Pasted image 20240412110720.png"></img></p>
...
<p><img src="/markdown/ai/assets/Pasted image 20240412110957.png" alt="Pasted image 20240412110957.png"></img></p>
<p>机制：将多个prompt vectors 放在每个multi-head attention的key矩阵和value矩阵之前
计算方式：相当于原始的token要多和这些soft prompt token计算相似度，然后聚合。
<img src="/markdown/ai/assets/Pasted image 20240412105532.png" alt="Pasted image 20240412105532.png"></img>
<img src="/markdown/ai/assets/Pasted image 20240412105740.png" alt="Pasted image 20240412105740.png"></img>
...
<h2>从提示调优（<a href="/#/document/ai/conceptions/PEFT(Parameter-Efficient Fine-Tuning)/Prompt Tuning.md">Prompt Tuning</a>）到前缀调优（Prefix Tuning）</h2>
...
<p><img src="/markdown/ai/assets/Pasted image 20240412112150.png" alt="Pasted image 20240412112150.png"></img></p>
...
<p><img src="/markdown/ai/assets/Pasted image 20240412112324.png" alt="Pasted image 20240412112324.png"></img></p>
