...
ListenPort = 38923 # Wireguard监听端口，默认是51820
# 后面六行别动，是开启转发和NAT，但如果你是客户端，就不需要这六行了，直接删掉
...
[Peer]
PublicKey = 此机器公钥
AllowedIPs = 192.168.238.2/24 # 此机器内网的子网，可以随意设定子网
Endpoint = 公网IP1:WG端口1 # 没公网别写
PersistentKeepalive = 25

[Peer]
PublicKey = 此机器公钥
# 此机器内网IP，/32意思是子网掩码是255.255.255.255，换言之这玩意只有自己的IP作为子网
